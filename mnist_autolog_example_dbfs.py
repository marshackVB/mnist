...
class MNISTDataModule(pl.LightningDataModule):
    def __init__(self, **kwargs):
        ...
        self.dbfs_data_path = '/dbfs/Users/marshall.carter@databricks.com/mnist'
        self.args = kwargs
    ...
    def setup(self, stage=None):
        ...
        self.df_train = datasets.MNIST(
            self.dbfs_data_path, download=False, train=True, transform=self.transform
        )
        self.df_train, self.df_val = random_split(self.df_train, [55000, 5000])
        self.df_test = datasets.MNIST(
            self.dbfs_data_path, download=False, train=False, transform=self.transform
        )
